...
export const translations = {
  en: {
    ...
    aiReportAnalysis: "AI Analysis",
    aiReportAnalysisTitle: "AI Report Analysis",
    aiReportAnalysisSubtitle: "Let AI analyze reports and provide recommendations. You approve or deny each suggestion.",
    analyzeWithAI: "Analyze with AI",
    analyzing: "Analyzing...",
    readyToAnalyze: "Ready to Analyze",
    readyToAnalyzeDescription: "Select a report status and click \"Analyze with AI\" to get intelligent recommendations.",
    ...
    ban: "Ban",
    unban: "Unban",
    unsuspendUserTitle: "Unsuspend User",
    unbanUserTitle: "Unban User",
    confirmUnsuspendUser: "Restore messaging for",
    confirmUnbanUser: "Unban",
    banUserWarning: "This will completely disable their account.",
    userSuspended: "User messaging suspended successfully",
    userBanned: "User banned successfully",
    userUnbanned: "User unbanned successfully",
    // AI Report Analysis
    recommendationApplied: "Recommendation applied successfully!",
    bulkActionApplied: "Bulk action applied successfully!",
    ...
    aiHowItWorks: "How it works",
    aiAnalyzesReports: "AI analyzes reports based on severity, patterns, and user history",
    recommendationsPrioritized: "Recommendations are prioritized by urgency",
    reviewAndApprove: "You review and approve or deny each recommendation",
    actionsExecuteAfterApproval: "Actions only execute after your explicit approval",
    urgent: "Urgent",
    medium: "Medium",
    low: "Low",
    applying: "Applying...",
    ...
    confirmApplyAction: "Confirm Action",
    confirmBulkActionMessage: "Apply",
    confirmApplyActionMessage: "Apply",
    to: "to",
    toThisReport: "to this report",
    noReportsForStatus: "No reports found for this status to analyze.",
    // AI Chat
  ...
  ar: {
    ...
    aiReportAnalysis: "تحليل الذكاء الاصطناعي",
    aiReportAnalysisTitle: "تحليل البلاغات بالذكاء الاصطناعي",
    aiReportAnalysisSubtitle: "دع الذكاء الاصطناعي يحلل البلاغات ويقدم توصيات. أنت توافق أو ترفض كل اقتراح.",
    analyzeWithAI: "تحليل بالذكاء الاصطناعي",
    analyzing: "جاري التحليل...",
    readyToAnalyze: "جاهز للتحليل",
    readyToAnalyzeDescription: "اختر حالة البلاغ وانقر على \"تحليل بالذكاء الاصطناعي\" للحصول على توصيات ذكية.",
    ...
    applied: "تم التطبيق",
    denied: "مرفوض",
    reportedUserLabel: "المستخدم المُبلغ عنه",
    ...
    ban: "حظر",
    unban: "إلغاء الحظر",
    unsuspendUserTitle: "إلغاء إيقاف المستخدم",
    unbanUserTitle: "إلغاء حظر المستخدم",
    confirmUnsuspendUser: "استعادة المراسلة لـ",
    confirmUnbanUser: "إلغاء حظر",
    banUserWarning: "سيؤدي هذا إلى تعطيل حسابه بالكامل.",
    userSuspended: "تم إيقاف مراسلة المستخدم بنجاح",
    userBanned: "تم حظر المستخدم بنجاح",
    userUnbanned: "تم إلغاء حظر المستخدم بنجاح",
    // AI Report Analysis
    recommendationApplied: "تم تطبيق التوصية بنجاح!",
    bulkActionApplied: "تم تطبيق الإجراء الجماعي بنجاح!",
    cachedResults: "عرض النتائج المخزنة مؤقتاً",
    ...
    aiHowItWorks: "كيف يعمل",
    aiAnalyzesReports: "يحلل الذكاء الاصطناعي البلاغات بناءً على الخطورة والأنماط وسجل المستخدم",
    recommendationsPrioritized: "يتم ترتيب التوصيات حسب الأولوية",
    reviewAndApprove: "تراجع وتوافق أو ترفض كل توصية",
    actionsExecuteAfterApproval: "يتم تنفيذ الإجراءات فقط بعد موافقتك الصريحة",
    urgent: "عاجل",
    medium: "متوسط",
    low: "منخفض",
    ...
    confirmApplyAction: "تأكيد الإجراء",
    confirmBulkActionMessage: "تطبيق",
    confirmApplyActionMessage: "تطبيق",
    to: "على",
    toThisReport: "على هذا البلاغ",
    noReportsForStatus: "لا توجد بلاغات لهذه الحالة للتحليل.",
    // AI Chat
