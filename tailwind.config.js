  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'hero-pattern-dark': "linear-gradient(rgba(0,0,0,.55),rgba(0,0,0,.45)),url('data:image/svg+xml,<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 1200 600\"><rect fill=\"%231e2025\" width=\"1200\" height=\"600\"/><path fill=\"%234f46e5\" opacity=\"0.4\" d=\"M0 400 Q300 350 600 400 T1200 400 V600 H0 Z\"/></svg>')",
